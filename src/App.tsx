...
const VibeScreen = React.lazy(() => import('./features/vibe/VibeScreen'));
...
const ToolsTab = React.lazy(() => import('./features/tools/ToolsTab'));
const GithubScreen = React.lazy(() => import('./features/tools/github/GithubScreen'));
              ...
              <React.Suspense fallback={
                  ...
                  <Routes>
                    ...
                    <Route element={<MainLayout />}>
                      ...
                      <Route path="/tools" element={user ? <ToolsTab /> : <Navigate to="/login" />} />
                      <Route path="/vibe" element={user ? <VibeScreen /> : <Navigate to="/login" />} />
                    ...
                    <Route path="/tools/github" element={user ? <GithubScreen /> : <Navigate to="/login" />} />
