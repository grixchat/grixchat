...
const TAB_PATHS = ['/', '/chats', '/calls', '/tools', '/reels', '/profile', '/notifications', '/vibe'];
const MAIN_TABS = ['/', '/calls', '/tools', '/vibe', '/profile'];
    ...
    <div className="h-full flex flex-col overflow-hidden">
      ...
      >
        <Suspense fallback={
          ...
          {visitedTabs['/tools'] && (
            <div className={location.pathname === '/tools' ? 'h-full w-full' : 'hidden'}>
              <ToolsTab />
            </div>
          )}
          
          {visitedTabs['/vibe'] && (
            <div className={location.pathname === '/vibe' ? 'h-full w-full' : 'hidden'}>
              <VibeScreen />
            </div>
          )}
