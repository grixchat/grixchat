...
export default function HubTab() {
  ...
  const activeFilter = activeFilters['hub'] || 'All';
  ...
  const sections: HubSection[] = [
    {
      ...
      items: [
        { id: 'github', name: 'Github', subtitle: 'Global repository system & sync', icon: Github, color: 'bg-zinc-900', badge: 'Devs', path: '/hub/github' },
